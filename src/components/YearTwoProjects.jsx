...
const PROJECTS = [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    documents: [
      { name: '整体模型', path: asset('/projects/2/斯特林发动机/xin v11.step') },
      { name: '墙体分析小作业', path: asset('/projects/2/斯特林发动机/墙体分析.zip') },
      ...
      { name: '斯特林发动机机械系统动力学仿真', path: asset('/projects/2/斯特林发动机/斯特林发动机机械系统动力学仿真.pdf') },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: [
      ...
      asset('/projects/2/仿生机械臂/元器件.jpg'),
      asset('/projects/2/仿生机械臂/3D打印模型.jpg'),
      asset('/projects/2/仿生机械臂/机械臂仿真.png'),
      asset('/projects/2/仿生机械臂/IMG_20241229_215904.jpg'),
    ],
    documents: [
      { name: 'MediaPipe笔记.pdf', path: asset('/projects/2/仿生机械臂/MediaPipe（完成）.pdf') },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    documents: [
      ...
      { name: '机械臂v3.step', path: asset('/projects/2/个性化实践/仿生手臂整体 v3.step') },
      { name: '机械臂v3.stl', path: '/projects/2/个性化实践/仿生手臂整体 v3.stl' },
      { name: '气缸报告.pdf', path: asset('/projects/2/个性化实践/气缸报告.pdf') },
      { name: '热力学报告.pdf', path: asset('/projects/2/个性化实践/热力学报告.pdf') },
      { name: '心电检测.pdf', path: asset('/projects/2/个性化实践/心电信号检测.pdf') },
      { name: '斯特林动力学.pdf', path: asset('/projects/2/个性化实践/斯特林发动机机械系统动力学仿真.pdf') },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: [
      ...
      asset('/projects/2/信号分析仪/板子.png'),
      asset('/projects/2/信号分析仪/预处理.png'),
      asset('/projects/2/信号分析仪/AI标注.png'),
      asset('/projects/2/信号分析仪/AI标注1.png'),
      asset('/projects/2/信号分析仪/AI标注2.png'),
    ],
    documents: [
      { name: '最终报告.docx', path:'/projects/2/信号分析仪/最终报告.docx', },
      { name: '运行文件.zip', path:asset('/projects/2/信号分析仪/ECG.zip'), },
      { name: 'IIR数字滤波器.pptx', path: asset('/projects/2/信号分析仪/第4章  IIR数字滤波器设计.pptx') },
      { name: 'FIR数字滤波器.pptx', path: asset('/projects/2/信号分析仪/第5章  FIR数字滤波器设计.pptx') },
      { name: '卡尔曼滤波.pdf', path: asset('/projects/2/信号分析仪/卡尔曼滤波.pdf') },
      { name: '离散信号系统.pptx', path: asset('/projects/2/信号分析仪/第1章  离散时间信号和离散时间系统.pptx') },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: [
      ...
      asset('/projects/2/keyshot渲染案例/可口可乐.jpg'),
      asset('/projects/2/keyshot渲染案例/沙漠水杯.14.png'),
      asset('/projects/2/keyshot渲染案例/音响.png'),
      asset('/projects/2/keyshot渲染案例/铝合金2.png'),
      asset('/projects/2/keyshot渲染案例/动画.gif'),
    ],
    documents: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    documents: [
      { name: '邀请信.pdf', path: asset('/projects/2/SUTD访学申请/Chongqing University_Invitation Letter.pdf') },
      { name: '学习计划(英文).pdf', path: asset('/projects/2/SUTD访学申请/学习计划（英文版）.pdf') },
      { name: 'CSC资格证书.pdf', path: asset('/projects/2/SUTD访学申请/CSC20232846+肖楚煜.pdf') },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    documents: [
      { name: '课程报告.pdf', path: asset('/projects/2/机器人基础/机器人技术-明创班-课程报告(1).pdf') },
      { name: '机械臂运动学.pdf', path: asset('/projects/2/机器人基础/机械臂运动（完成）.pdf') },
