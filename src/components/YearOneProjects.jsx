...
const PROJECTS = [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: [
      '/projects/1/产品设计/图片/产品.png',
      '/projects/1/产品设计/图片/实物.png',
      '/projects/1/产品设计/图片/背景.png',
      '/projects/1/产品设计/海报.png',
      '/projects/1/产品设计/模型.png',
      '/projects/1/产品设计/页面1.png',
    ],
    documents: [
      { name: '最终汇报.pptx', path: '/projects/1/产品设计/泳伴科技最终.pptx' },
      { name: '眼镜模型.step', path: '/projects/1/产品设计/眼镜 v3.step' },
      { name: '整体装配.step', path: '/projects/1/产品设计/整体.step' },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: [
      '/projects/1/2024年个性化实践答辩/A海格力斯越野型小车 v1.png',
      '/projects/1/2024年个性化实践答辩/初代 模型.png',
      '/projects/1/2024年个性化实践答辩/仿生手臂整体 v1.png',
      '/projects/1/2024年个性化实践答辩/仿生手臂整体 v2.png',
      '/projects/1/2024年个性化实践答辩/个性化实践2.png',
      '/projects/1/2024年个性化实践答辩/整车.png',
      '/projects/1/2024年个性化实践答辩/时间占比.png',
    ],
    documents: [
      { name: '答辩PPT.pptx', path: '/projects/1/2024年个性化实践答辩/2024个性化实践--肖楚煜.pptx' },
      { name: '答辩PDF.pdf', path: '/projects/1/2024年个性化实践答辩/2024个性化实践--肖楚煜.pdf' },
      { name: '整机装配.STEP', path: '/projects/1/2024年个性化实践答辩/整机装配.STEP' },
      { name: '仿生机械臂.ksp', path: '/projects/1/2024年个性化实践答辩/仿生机械臂.ksp' },
      { name: '实践报告.pdf', path: '/projects/1/2023年个性化实践报告/肖楚煜个性化实践报告.pdf' },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: [
      '/projects/1/重庆夏令营——明月湖/产品图.jpg',
      '/projects/1/重庆夏令营——明月湖/Demo Day PPT.png',
      '/projects/1/重庆夏令营——明月湖/1.png',
      '/projects/1/重庆夏令营——明月湖/中期汇报PPT制作的思维导图.png',
    ],
    documents: [
      { name: '最终汇报.pptx', path: '/projects/1/重庆夏令营——明月湖/最终版本.pptx' },
      { name: '竞品分析.pptx', path: '/projects/1/重庆夏令营——明月湖/竞品分析.pptx' },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: [
      '/projects/1/致行科技实习/founder.png',
      '/projects/1/致行科技实习/测试.png',
      '/projects/1/致行科技实习/logo.png',
      '/projects/1/致行科技实习/背包.png',
      '/projects/1/致行科技实习/设计稿.jpg',
    ],
    documents: [
      { name: '预路演', path: '/projects/1/致行科技实习/【保密】肖楚煜内部学习资料/海格力斯项目7月预演.pptx' },
      { name: '布袋设计稿', path: '/projects/1/致行科技实习/布袋设计/设计稿.pptx' },
      { name: '竞品分析', path: '/projects/1/致行科技实习/竞品分析/竞品分析（内部资料）.pptx' },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    documents: [
      ...
      { name: '底盘.step', path: '/projects/1/Robocon战队/底盘/底盘 v30.step' },
      { name: '机器人.step', path: '/projects/1/Robocon战队/机器人/机器人R1总装 v72.step' },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: [
      '/projects/1/物理实验/11月12日/实验效果.gif',
      '/projects/1/物理实验/11月12日/稳定装填.gif',
      '/projects/1/物理实验/11月12日/深度.gif',
      '/projects/1/物理实验/卡皮查摆动.gif',
      '/projects/1/物理实验/仿真和试验.png',
    ],
    documents: [
      { name: '悬浮液最终版.pptx', path: '/projects/1/物理实验/悬浮液最终版本3.pptx' },
      { name: 'comsol仿真.mph', path: '/projects/1/物理实验/仿真二维湍流 甘空甘.mph' },
      { name: '参考文献.pdf', path: '/projects/1/物理实验/floating中文.pdf' },
      { name: '卡皮查摆理论.pdf', path: '/projects/1/物理实验/卡皮查摆.pdf' },
      { name: '理论.pdf', path: '/projects/1/物理实验/理论.pdf' },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: ['/projects/1/工程原理/video_20240519_175309.gif',
              '/projects/1/工程原理/循迹.png',
    ],
    documents: [
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: ['/projects/1/定量工程分析/船1.png',
             '/projects/1/定量工程分析/船2.jpg',    ],
    documents: [
      { name: 'QEA报告v3.docx', path: '/projects/1/定量工程分析/qea报告3.0(1).docx' },
      { name: '水翼模型v7.step', path: '/projects/1/定量工程分析/船.step' },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    images: ['/projects/1/线性代数/matlabapp.png',
             '/projects/1/线性代数/code.png',
    ],
    documents: [
      {name: '总项目压缩包',   path: '/projects/1/线性代数/人脸识别进阶版.zip',
       name: '照片库',   path: '/projects/1/线性代数/照片库.zip'
       },
    ],
  },
