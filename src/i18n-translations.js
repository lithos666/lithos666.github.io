...
export const translations = {
  ...
  'hero.proof-funding': {
    zh: 'Goodent · 50 万元种子轮',
    en: 'Goodent · RMB 500k seed funding'
  },
  'hero.cta-projects': {
    zh: '查看代表项目',
  ...
  'project.pneumatic.title': {
    zh: '气动小车',
    en: 'Pneumatic Vehicle'
  },
  'project.pneumatic.category': {
    zh: '机械工程 · 3D 打印 · 车辆设计',
  ...
  'project.flowerpot.title': {
    zh: '兰精灵 · 智能养护花盆',
    en: 'Lanjingling Smart Flower Pot'
  },
  'project.flowerpot.category': {
    zh: '创新创业 · IoT · 嵌入式',
  ...
  'project.bldc.title': {
    zh: 'DIY 无刷直流电机（BLDC）',
    en: 'DIY Brushless DC Motor (BLDC)'
  },
  'project.bldc.category': {
    zh: '电机设计 · 3D 打印 · 嵌入式控制',
  ...
  'knowledge.card-1-title': {
    zh: '前端技术栈',
    en: 'Frontend Tech Stack'
  },
  'knowledge.card-2-title': {
    zh: '硬件开发工具链',
    en: 'Hardware Dev Toolchain'
  },
  'knowledge.card-3-title': {
    zh: '设计与仿真平台',
    en: 'Design & Simulation Platforms'
  },
  ...
  // Common UI Elements
  'ui.tags': {
    zh: ['BLDC', '3D 打印', 'ESP32-S3', '电调驱动', '无感换向'],
    en: ['BLDC', '3D Printing', 'ESP32-S3', 'ESC Drive', 'Sensorless Commutation']
  },
  'view-details': {
    zh: '查看详情',
    en: 'View Details'
  ...
  // ===== Year One Projects Detailed Translations =====
  'y1.project.product-design.title': {
    zh: '产品设计 · 泳伴科技',
    en: 'Product Design · SwimMate Technology'
  },
