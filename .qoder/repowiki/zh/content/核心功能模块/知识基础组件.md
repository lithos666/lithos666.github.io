...
## 更新摘要
**变更内容**   
- 完全重新设计KnowledgeBase组件架构，移除搜索功能和分类标签工具栏
- 采用扁平化布局结构，简化用户交互流程
- 卡片尺寸缩小并重新组织为基于行的分组列表布局
- 优化渲染性能，提升内容浏览体验
...
**更新** 组件已完全重新设计，移除了复杂的搜索和过滤功能，采用更简洁的扁平化布局，专注于内容的清晰展示和高效浏览。
...
- 配置层：constants.js 用于集中配置（如分类、标签、条目元数据等）；package.json 为工程配置
